...
// AddBookmarks adds the "bookmarks" edges to the Link entity.
func (uu *UserUpdate) AddBookmarks(l ...*Link) *UserUpdate {
	ids := make([]uuid.UUID, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
...
// RemoveBookmarkIDs removes the "bookmarks" edge to Link entities by IDs.
func (uu *UserUpdate) RemoveBookmarkIDs(ids ...uuid.UUID) *UserUpdate {
	uu.mutation.RemoveBookmarkIDs(ids...)
	return uu
}

// RemoveBookmarks removes "bookmarks" edges to Link entities.
func (uu *UserUpdate) RemoveBookmarks(l ...*Link) *UserUpdate {
	ids := make([]uuid.UUID, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
...
// AddBookmarks adds the "bookmarks" edges to the Link entity.
func (uuo *UserUpdateOne) AddBookmarks(l ...*Link) *UserUpdateOne {
	ids := make([]uuid.UUID, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
...
// RemoveBookmarks removes "bookmarks" edges to Link entities.
func (uuo *UserUpdateOne) RemoveBookmarks(l ...*Link) *UserUpdateOne {
	ids := make([]uuid.UUID, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
